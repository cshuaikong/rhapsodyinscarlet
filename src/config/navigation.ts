...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  { key: 'characters', path: '/characters', icon: 'lucide:users', isContentType: true, order: 1 },
  { key: 'beasts', path: '/beasts', icon: 'lucide:folder', isContentType: true, order: 2 },
  { key: 'abilities', path: '/abilities', icon: 'lucide:folder', isContentType: true, order: 3 },
  { key: 'story', path: '/story', icon: 'lucide:folder', isContentType: true, order: 4 },
  { key: 'gameplay', path: '/gameplay', icon: 'lucide:folder', isContentType: true, order: 5 },
  { key: 'trailers', path: '/trailers', icon: 'lucide:folder', isContentType: true, order: 6 },
  { key: 'release-date', path: '/release-date', icon: 'lucide:folder', isContentType: true, order: 7 },
];
